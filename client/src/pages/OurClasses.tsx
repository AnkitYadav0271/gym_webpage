...
const overlayStyles = `p-5 absolute z-30 flex h-[287px]  flex-col items-center justify-center whitespace-normal bg-[#ff616a] text-center text-white transition duration-500 opacity-0 hover:opacity-90 overflow-hidden`
    return (
        <section id="our-classes" className="w-full bg-[#DFCCCC]">
                        ...
                        <ul className="w-[2800px] whitespace-nowrap">

                            {
                                gymClasses.map((ourClass)=>(
                                    <li className="mx-5 relative inline-block h-[380px] w-[380px] " key={ourClass.id}>
                                        <div className={overlayStyles}>
                                            <p>{ourClass.name}</p>
                                            <p>{ourClass.description}</p>
                                        </div>
